...
<p align="center">
  ...
  <a href="#additional-materials" style="display:inline-block; margin:0 6px 8px 0; padding:10px 14px; background:linear-gradient(135deg,#10b981,#0b9f6f); color:#ffffff; text-decoration:none; border-radius:999px; font-weight:700; box-shadow:0 4px 10px rgba(16,185,129,0.35); border:1px solid rgba(255,255,255,0.15);">Materials</a>
  <a href="#repository-structure" style="display:inline-block; margin:0 6px 8px 0; padding:10px 14px; background:linear-gradient(135deg,#f59e0b,#d97706); color:#ffffff; text-decoration:none; border-radius:999px; font-weight:700; box-shadow:0 4px 10px rgba(245,158,11,0.35); border:1px solid rgba(255,255,255,0.15);">Repo Structure</a>
</p>
<p align="center">
  ...
  <a href="#m3-scalable-architecture" style="display:inline-block; margin:0 6px 8px 0; padding:10px 14px; background:linear-gradient(135deg,#1f6feb,#0a58ca); color:#ffffff; text-decoration:none; border-radius:999px; font-weight:700; box-shadow:0 4px 10px rgba(31,111,235,0.35); border:1px solid rgba(255,255,255,0.15);">M3</a>
  <a href="#m4-trustworthy-data-economies" style="display:inline-block; margin:0 6px 8px 0; padding:10px 14px; background:linear-gradient(135deg,#1f6feb,#0a58ca); color:#ffffff; text-decoration:none; border-radius:999px; font-weight:700; box-shadow:0 4px 10px rgba(31,111,235,0.35); border:1px solid rgba(255,255,255,0.15);">M4</a>
  <a href="#m5-industry-ecosystem" style="display:inline-block; margin:0 6px 8px 0; padding:10px 14px; background:linear-gradient(135deg,#1f6feb,#0a58ca); color:#ffffff; text-decoration:none; border-radius:999px; font-weight:700; box-shadow:0 4px 10px rgba(31,111,235,0.35); border:1px solid rgba(255,255,255,0.15);">M5</a>
</p>
...
| **Duration** | 2 hours |
| **Repository** | `ieee-icbc-tutorial-qbe` |
...
| Segment | Module | Presenter | Description |
|:---|:---|:---|:---|
| **M0** | [Opening Demo](#m0-opening-demo) | Dongping Liu, Aoyu Zhang, Luyao Zhang | Quantum-Web3-AI Convergence -- interactive applications |
| **M1** | [Embodied AI & World Models](#m1-embodied-ai--world-models) | Song Guo (HKUST) | IRASim, WMPO, and the bridge to blockchain infrastructure |
| **M2** | [Quantum Hardware Threat](#m2-quantum-hardware-threat) | Aoyu Zhang (AWS) | AWS Braket demo, PQC standards, threat timelines |
| **M3** | [Scalable Architecture](#m3-scalable-architecture) | Huawei Huang (SYSU) | BlockEmulator, BrokerChain, cross-shard protocols |
| **M4** | [Trustworthy Data Economies](#m4-trustworthy-data-economies) | Luyao Zhang (DKU) | Croissant metadata, provenance, incentives |
| **M5** | [Industry Ecosystem](#m5-industry-ecosystem) | Dongping Liu (Tenorshare) | Operationalizing trustworthy AI agent infrastructure |
| **Panel** | [Closing Synthesis](#closing-panel) | All Speakers | Integrated QBE roadmap and future directions |
...
| Live Demo | `bash example_run.sh` -- 4 shards x 4 nodes + 1 supervisor |
...
A unified infrastructure where quantum-resistant security, scalable coordination, and trustworthy data economies jointly power next-generation Cyber-Physical-Social Systems.
...
|   |-- (slides, videos)
|
|-- M1                 # M1: Embodied AI & World Models
|   |-- (slides, videos)
|
|-- M2                 # M2: Quantum Hardware Threat Assessment
|   |-- (slides, videos)
|
|-- M3                 # M3: Scalable Architecture & Interoperability
|   |-- (slides, videos)
|
|-- M4                 # M4: Trustworthy Data Economies
|   |-- (slides, videos)
|
|-- M5                 # M5: Industry Ecosystem Integration
    |-- (slides, videos)
```
...
<p align="center">
  <em>QBE -- Quantum / Blockchain / Embodied AI</em><br>
  <sub>IEEE ICBC 2026 / June 1--5, 2026 / Brisbane, Australia</sub>
</p>
